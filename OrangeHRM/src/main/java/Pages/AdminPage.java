...
public class AdminPage {
    ...
    public void clickadminButton() {
        AdminDriver.findElement(AdminButtonLocator).click();
    }
    ...
    {
        WebElement elementToClear = AdminDriver.findElement(FromWorkHourLocator);
        elementToClear.click();
        Actions actions = new Actions(AdminDriver);
    ...
    public void typeFromHour(String FromHour) {
        WebElement fromhourElement = AdminDriver.findElement(FromWorkHourLocator);

        fromhourElement.sendKeys(FromHour); // Send the new EmployeeID
    }

    public void ClearTextTo( )
    {
        WebElement elementToClear = AdminDriver.findElement(ToWorkHourLocator);
        elementToClear.click();
        Actions actions = new Actions(AdminDriver);
        actions.keyDown(Keys.CONTROL).sendKeys("a").keyUp(Keys.CONTROL);
        actions.perform();
    ...
    public void typeToHour(String ToHour) {
        WebElement tohourElement = AdminDriver.findElement(ToWorkHourLocator);

        tohourElement.sendKeys(ToHour); // Send the new EmployeeID
    }
